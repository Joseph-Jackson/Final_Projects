            ...
            <footer class="sticky-footer bg-white shadow border py-3">
                <div class="container-fluid my-auto">
                    <div class="copyright text-center my-1 d-flex justify-content-between">
                        <div class="col-auto"><b>Developed By: </b> <?php echo('<strong>Jozee_Tz </strong>');?></div>
                        <div class="col-auto"><span>&copy; Mwecau payroll Management System - <?php echo date('Y')?> Version 1.0</span>
                        </div>
                    </div>
                </div>
            </footer>
